            ...
            <div class="admin-form theme-info mw500" id="login">
                ...
                <div class="panel mt30 mb25">
                    ...
                    <div class="panel-footer clearfix">
                        <button type="button" class="button btn-primary mr10 pull-right" onclick="login()">登陆</button>
...
<script src="${pageContext.request.contextPath}/vendor/jquery/jquery_2_1.min.js" charset="UTF-8"></script>
