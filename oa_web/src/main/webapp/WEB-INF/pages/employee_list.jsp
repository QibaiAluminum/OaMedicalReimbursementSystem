                ...
                <div class="panel-menu">
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light" onclick="refresh()">
                                    <i class="fa fa-refresh"></i>
                                </button>
                                <button type="button" class="btn btn-default light" onclick="javascript:window.location.href='/employee/to_add';">
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1" style="text-align: center;">
                        ...
                        <c:forEach items="${list}" var="emp">
                            <tr class="message-unread">
                                ...
                                <td class="hidden-xs">
                                    <span class="badge badge-warning fs11">${emp.post}</span>
                                </td>
                                <td>
